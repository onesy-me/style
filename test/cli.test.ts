  ...
  to('cli', done => {
    ...
    childProcess.on('message', async () => {
      const files = {
        ...
        reset: await AmauiNode.file.get(path.resolve('./test/folders/css/reset.21fa912fbfe3dfca71d530f703ffdbf13bf0475e753140dfa66cc9e33a6d769a.css'), false),
...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Document</title>
    <link rel='stylesheet' href='../css/reset.21fa912fbfe3dfca71d530f703ffdbf13bf0475e753140dfa66cc9e33a6d769a.css' data-amaui='true' data-reset='true' />
