  ...
  to('cli', done => {
    ...
    childProcess.on('message', async () => {
      const files = {
        ...
        reset: await AmauiNode.file.get(path.resolve('./test/folders/css/reset.8c9f53bd1f90ec94d724883e8248003effe42c8dd5637803dbc306bf629c7489.css'), false),
...
<html lang="en">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Document</title>
    <link rel='stylesheet' href='../css/reset.8c9f53bd1f90ec94d724883e8248003effe42c8dd5637803dbc306bf629c7489.css' data-amaui='true' data-reset='true' />
